...
function displayNextDays(forc) {
  ...
  for (var i = 1; i < forc.length; i++) {
    ...
    var cardClass = i === 2 ? "second-card" : "";
    var headerClass = i === 2 ? "sec-card" : ""
    cartoona += `<div class="col-md-6 col-lg-4 " >
    <div class="inner sec-card ${cardClass}" id="card2">
              <p
                class="text-color rounded-bottom-0 main-color ${headerClass} text-center mb-0 py-2"
              >
